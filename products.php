                ...
                <div class="col-lg-3 col-md-5">
                    <div class="sidebar">
                        ...
                        <div class="sidebar__item">
                            <h4>Categorias</h4>
                            <ul>
                                <li class="c-pointer"><a data-filter="*">🏷 Todos</a></li>
                      ...
                      <!--   <div class="row">
                        ...
                        <div class="row featured__filter">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 mix 
                             ...
                             <?php echo $row_products['subcategory']; ?>
                             <?php echo $row_products['color']; ?>
                             <?php echo $row_products['event']; ?>">
                                <div class="featured__item">
                                    <div class="featured__item__pic set-bg" data-setbg="<?php echo $row_products['image']; ?>">
                                    <ul class="featured__item__pic__hover">
                                        <li><a title="Eliminar" onclick="removeToCart('<?php echo $row_products['id']; ?>')"><i class="fa fa-minus"></i></a></li>
                                        <li><a id="count-product-<?php echo $row_products['id']; ?>">0
                                        
                                        
                                        <!--   -->
                                        
                                         <script>
                                            const prod<?php // echo $row_products['id']; ?> = document.getElementById("count-product-<?php echo $row_products['id']; ?>");
                                        ...
                                        <li><a title="Agregar" onclick="addToCart('<?php echo $row_products['id']; ?>', '<?php echo $row_products['name']; ?>', '<?php echo $row_products['price']; ?>')"><i class="fa fa-plus"></i></a></li>
                                    </ul>
                                    </div>
                                    <div class="featured__item__text">
                                        <h6><a href="#"><?php echo $row_products['name']; ?> <span style="text-decoration: underline">Pack X3 unidades</span></a></h6>
                                        <h5>$<?php echo str_replace(",", ".", number_format($row_products['price'])); ?></h5>
                                    </div>
                                </div>
                            </div>
                            <?php } ?> 
